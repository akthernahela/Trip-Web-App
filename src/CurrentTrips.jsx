export const currentTrips = [
    ...
    },
    {
        ...
        participants: [
            ...
            { id: 5, name: 'Andrea Marino', email: 'andrea.marino@email.com', phone: '+39 348 5555555', fiscalCode: 'MRNNDR91C12H501V' }
        ]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        participants: [
            ...
            { id: 10, name: 'Chiara Romano', email: 'chiara.romano@email.com', phone: '+39 338 0000000', fiscalCode: 'RMNCHR96T45H501V' },
            { id: 11, name: 'Davide Fontana', email: 'davide.fontana@email.com', phone: '+39 349 1010101', fiscalCode: 'FNTDVD87A12H501X' }
        ]
    },
